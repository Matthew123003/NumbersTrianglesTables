...
public class NumberUtilitiesTest {
    ...
    public void testGetRange1A() {
        ...
        int stop = 10;//Matt changed from 10, it was 11 which is wrong
    ...
    public void testGetRange3B() {
        // : Given
        String expected = "100101102103104105106107108109";//Matt added 102, was missing
        int start = 100;
        int stop = 110;
    ...
    public void testGetOddNumbers() {
        // : Given
        String expected = "5791113151719";//Matt swapped with even numbers test
        int start = 5;
        int stop = 20;
        int step = 5;
